...
pub(super) fn normalized_target(authored: &str) -> String {
    authored
        .split(['|', '#'])
        .next()
        .unwrap_or(authored)
...
pub(super) fn occurrences(source: &str) -> Vec<LinkOccurrence> {
...
pub(super) fn rewrite(source: &str, replacements: &[(usize, String)]) -> String {
